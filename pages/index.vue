<template>
    ...
    <section class="contentblock" id="skills">
        <h2>Ich arbeite mit</h2>
        <ul>
            <Skill skillName="Adobe"
                :subcategories="['Illustrator', 'Photoshop', 'InDesign', 'Premiere Pro', 'After Effects', 'Lightroom']" />
